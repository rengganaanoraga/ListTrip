...
$query = mysqli_query($connect_db, "SELECT * FROM `destination` WHERE id = ".$idDestination);
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="location" class="form-control" value="<?php echo $dataValue['location']?>"/>
                                            </div>            
                                    ...
                                    <div class="form-group">                                        
                                        <label class="col-md-3 col-xs-12 control-label">Ticket Prive</label>
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-ticket"></span></span>
                                                <input type="number" name="price" class="form-control" value="<?php echo $dataValue['ticket']?>">                                            
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <textarea  class="form-control" rows="5" name="description"><?php echo $dataValue['description'] ?></textarea>
...
<?php 
	...
	if ($submit) {
		$sql = mysqli_query($connect_db, "UPDATE `destination` SET `name` = '".$name."', `location` = '".$location."', `ticket` = '".$price."', `description` = '".$description."' WHERE `destination`.`id` = ".$idDestination);
		if ($sql) {
			echo "
        <script > alert('change destination succes'); window.location = 'manage-destination.php'</script>";
		}else{
            echo "
        <script > alert('change destination failed'); window.location = 'manage-destination.php'</script>";
        }
	}
?>